package com.shenfeng.yxw.auth.config;


import com.shenfeng.yxw.auth.domain.entity.OauthAccount;
import com.shenfeng.yxw.auth.domain.mapper.OauthAccountMapper;
